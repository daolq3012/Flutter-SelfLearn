...
import 'package:movie_db/util/style.dart';
import 'package:movie_db/widgets/text_bubble.dart';
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      body: new CustomScrollView(
        slivers: <Widget>[_buildAppBar(_movie), _buildContentSection(_movie)],
      ),
    );
  }
